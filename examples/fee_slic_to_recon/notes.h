/**
 * \page feeslictorecon fee\_slic\_to\_recon
 * 
 * This is an example of how to use the slic\_to\_recon\_job. Here, the input files contain beam data. The slic component simulates the detector response which means that the output of this job will vary with different detector setups.
 ...
 * 
 * This table contains parameters special to the slic\_to\_recon job. The general parameters are discussed on the \ref examples "examples main page".
 * | param           |                                                                                                                                              |
 * |-----------------|----------------------------------------------------------------------------------------------------------------------------------------------|
