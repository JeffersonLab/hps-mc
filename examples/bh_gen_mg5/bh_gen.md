BH generation and sampling {#wabgensample}
===========================

This is an example of how to use BH_gen_job.py The job generates wab events using MadGraph5 and transforms the output from lhe to stdhep to then rotate the events into beam coordinates.
