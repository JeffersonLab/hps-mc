...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,611,bn,elmass,100d0)
       call set_it(n,ivalue,value,name,622,bn,apmass,100d0)
       ...
       call set_it(n,ivalue,value,name,611,bn,elwidth,1d0)
       call set_it(n,ivalue,value,name,622,bn,apwidth,1d0)
       call set_it(n,ivalue,value,name,623,bn,hpwidth,1d0)
       bn='mguser'
