...
c************************************
      ...
      GZPD(1)=dcmplx(param1*( -ez*(-Half + sin2w/Three)),Zero)
      GZPD(2)=dcmplx(param2*( -ey/Three),Zero)
      GZPU(1)=dcmplx(param3*( -ez*( Half - sin2w*Two/Three)),Zero)
      GZPU(2)=dcmplx(param4*( ey*Two/Three),Zero)
      GZPL(1)=dcmplx(param5*( -ez*(-Half + sin2w)),Zero)
      GZPL(2)=dcmplx(param6*( -ey ),Zero)
      GZPN(1)=dcmplx(param7*(-ez*Half),Zero)
      GZPN(2)=dcmplx(param8*( Zero ),Zero)
      GWWZP=param9*ee*cw/sw
      GZPZPH=dcmplx(param10*(ee2/sc2*Half*v),Zero)
      GZPZPHH=dcmplx(param11*(ee2/sc2*Half),Zero)
...
99	continue      
       ...
       call set_it(n,ivalue,value,name,32,bn,zpmass,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,32,bn,zpwidth,1d0)
       bn="mguser"
       call set_it(n,ivalue,value,name,1,bn,param1 ,1d0)
       call set_it(n,ivalue,value,name,2,bn,param2 ,1d0)
       call set_it(n,ivalue,value,name,3,bn,param3 ,1d0)
       call set_it(n,ivalue,value,name,4,bn,param4 ,1d0)
       call set_it(n,ivalue,value,name,5,bn,param5 ,1d0)
       call set_it(n,ivalue,value,name,6,bn,param6 ,1d0)
       call set_it(n,ivalue,value,name,7,bn,param7 ,1d0)
       call set_it(n,ivalue,value,name,8,bn,param8 ,1d0)
       call set_it(n,ivalue,value,name,9,bn,param9 ,1d0)
       call set_it(n,ivalue,value,name,10,bn,param10 ,1d0)
       call set_it(n,ivalue,value,name,11,bn,param11 ,1d0)
