...
c
 ...
 25   format( 1x,a16,2x,f7.3,' GeV        ',a16,2x,f7.4,' GeV')
      ...
      write(6,*)  '---------------------'
      write(6,*)
      write(6,11) 'GAPL(L)  =  ', GAPL(1),'GAPL(R)  =  ', GAPL(2)
      write(6,11) 'GAPD(L)  =  ', GAPD(1),'GAPD(R)  =  ', GAPD(2)
      write(6,11) 'GAPU(L)  =  ', GAPU(1),'GAPU(R)  =  ', GAPU(2)
      write(6,20) 'GAAHD  =  ', GAAHD
      write(6,*)
      ...
      write(6,*) '-----------------------------'
      write(6,*)
      write(6,24) 'STMASS  =  ', STMASS, 'STWIDTH    = ', STWIDTH
      write(6,24) 'CHMASS  =  ', CHMASS, 'CHWIDTH    = ', CHWIDTH
      write(6,24) 'MUMASS  =  ', MUMASS, 'MUWIDTH    = ', MUWIDTH
