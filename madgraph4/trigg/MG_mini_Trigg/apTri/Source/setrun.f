...
c*********************************************************************
      ...
      call get_real   (npara,param,value,"efpos "       , efpos     , 0d0)
      call get_real   (npara,param,value,"thetafmin ", thetafmin , 0d0)
      call get_real   (npara,param,value,"thetaxfpos ", thetaxfpos, 0d0)
      call get_real   (npara,param,value,"thetayfpos ", thetayfpos, 0d0)
      call get_real   (npara,param,value,"xthetaxfmin ",xthetaxfmin, 0d0)
      call get_real   (npara,param,value,"xthetayfmin ",xthetayfmin, 0d0)
      call get_real   (npara,param,value,"efneg "    , efneg   , 0d0)
      call get_real   (npara,param,value,"thetafmax ", thetafmax, 100d0)
      call get_real   (npara,param,value,"thetaxfneg ", thetaxfneg, 0d0)
      call get_real   (npara,param,value,"thetayfneg ", thetayfneg, 0d0)
