...
c there is only one fp; check if it passes cuts
            ...
            if(
     $         is_a_fp(i).and.
     $         (thetax(plab(0,i)) .gt. thetaxfpos).and.
     $         (thetay(plab(0,i)) .gt. thetayfpos).and.
     $         (plab(0,i) .gt. efpos)) then
               passfp=.true.
               nfppass=nfppass+1
               jpassfp=i
            endif
...
c there are two fm's; check if one passes cuts
            ...
            if(
     $         is_a_fm(i).and.
     $         (thetax(plab(0,i)) .gt. thetaxfneg).and.
     $         (thetay(plab(0,i)) .gt. thetayfneg).and.
     $         (plab(0,i) .gt. efneg)) then
               passonefm=.true.
               nfmpass=nfmpass+1
               jpassfm(nfmpass)=i
            endif
