...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       call set_it(n,ivalue,value,name,628,bn,stmass,100d0)
       call set_it(n,ivalue,value,name,629,bn,chmass,100d0)
       call set_it(n,ivalue,value,name,613,bn,mumass,100d0)
       call set_it(n,ivalue,value,name,623,bn,apmass,100d0)
       call set_it(n,ivalue,value,name,625,bn,hpmass,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,628,bn,stwidth,1d0)
       call set_it(n,ivalue,value,name,629,bn,chwidth,1d0)
       call set_it(n,ivalue,value,name,613,bn,muwidth,1d0)
       call set_it(n,ivalue,value,name,623,bn,apwidth,1d0)
       call set_it(n,ivalue,value,name,625,bn,hpwidth,1d0)
       bn='mguser'
       call set_it(n,ivalue,value,name,1,bn,epsilon   ,0d0)
       call set_it(n,ivalue,value,name,2,bn,gdark     ,0d0)
      return
      end
