...
c************************************
      ...
      GAPL(1)=dcmplx(  ee*epsilon           , Zero)
      GAPL(2)=dcmplx(  ee*epsilon           , Zero)
      GAPD(1)=dcmplx(  ee*epsilon/Three     , Zero)
      GAPD(2)=dcmplx(  ee*epsilon/Three     , Zero)
      GAPU(1)=dcmplx( -ee*epsilon*Two/Three , Zero)
      GAPU(2)=dcmplx( -ee*epsilon*Two/Three , Zero)
      GAAHD=dcmplx( gDark , Zero)
