...
C  
C FOR PROCESS : e- n+ -> e- n+ a  
C  
C Crossing   1 is e- n+ -> e- n+ a  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C BEGIN CODE
C ----------
      CALL IXXXXX(P(0,1   ),ELMASS ,NHEL(1   ),+1*IC(1   ),W(1,1   ))      
      CALL OXXXXX(P(0,2   ),HPMASS ,NHEL(2   ),-1*IC(2   ),W(1,2   ))      
      CALL OXXXXX(P(0,3   ),ELMASS ,NHEL(3   ),+1*IC(3   ),W(1,3   ))      
      CALL IXXXXX(P(0,4   ),HPMASS ,NHEL(4   ),-1*IC(4   ),W(1,4   ))      
      CALL VXXXXX(P(0,5   ),ZERO ,NHEL(5   ),+1*IC(5   ),W(1,5   ))        
      CALL JIOXXX(W(1,4   ),W(1,2   ),GAN ,ZERO    ,AWIDTH  ,W(1,6   ))    
      CALL FVIXXX(W(1,1   ),W(1,5   ),GAL ,ELMASS  ,ZERO    ,W(1,7   ))    
      CALL IOVXXX(W(1,7   ),W(1,3   ),W(1,6   ),GAL ,AMP(1   ))            
      CALL FVOXXX(W(1,3   ),W(1,5   ),GAL ,ELMASS  ,ZERO    ,W(1,8   ))    
      CALL IOVXXX(W(1,1   ),W(1,8   ),W(1,6   ),GAL ,AMP(2   ))            
      JAMP(   1) = +AMP(   1)+AMP(   2)
      MATRIX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
