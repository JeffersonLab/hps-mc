      subroutine block_d(x,n_var,parg1,parg2,r1) 
...
c               * P1 (visible)
c
c     |P1| or |P2| must be left unfactorized, MV_r1 is aligned.
c     The choice is based on the width of the transfer function
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      implicit none
      include '../../genps.inc'
