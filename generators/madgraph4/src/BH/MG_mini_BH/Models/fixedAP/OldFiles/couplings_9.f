...
c     following line added by Rouven
      double precision aval, dval, apval, tval, elmass, Anuc, fullcoupling 
c
...
c************************************
      ...
      elmass = 0.000511
      Anuc = 184
      aval = 111/( elmass*Znuc**(1/3) )
      dval = 0.164/Anuc**(2/3)
      apval = 773/( elmass*Znuc**(2/3) ) 
      tval = -(pp(0,2)-pp(0,4))**2+(pp(1,2)-pp(1,4))**2+
      $         (pp(2,2)-pp(2,4))**2+(pp(3,2)-pp(3,4))**2
