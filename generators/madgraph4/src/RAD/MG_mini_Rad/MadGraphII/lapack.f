...
! Filename: lapack.f
!-----------------------
! The following routines are the portions of the netlib Lapack and BLAS
! packages necessary to compute the eigenvalues and eigenvectors of
! a real symmetric matrix.  They are supplied as part of madgraph
! for sites which do not have the Numerical Recipes routines
! tred2 and tqli available and do not have the Lapack library installed.
! Except for this comment block at the beginning of the file, these
! routines are unmodified by the madgraph authors.
!
! *********Lapack and BLAS Routines Begin Here ************
