    ...
    def def_all_mother(self):
        ...
        while 1:
            try:
                ...
                self.all_mother=all_mother
                break
            try:
                if propa.all_mother:
                    self.all_mother=all_mother+[propa]+propa.all_mother
                    break
            except:
                pass
            
            if propa!=0:
                all_mother.append(propa)
            try:
                return self.all_mother
            except:
                pass
...
class external_part(Particle):
    ...
    def is_invisible(self):
        ...
        invisible_list=[12,14,16,18,1000022,1000023,1000024,1000025,1000035]
