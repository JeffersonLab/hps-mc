...
C     
      ...
      DATA (NHEL(I,   1),I=1,7) / 1, 1,-1,-1, 1,-1, 0/
      DATA (NHEL(I,   2),I=1,7) / 1, 1,-1,-1, 1, 1, 0/
      DATA (NHEL(I,   3),I=1,7) / 1, 1,-1,-1,-1,-1, 0/
      DATA (NHEL(I,   4),I=1,7) / 1, 1,-1,-1,-1, 1, 0/
      DATA (NHEL(I,   5),I=1,7) / 1, 1,-1, 1, 1,-1, 0/
      DATA (NHEL(I,   6),I=1,7) / 1, 1,-1, 1, 1, 1, 0/
      DATA (NHEL(I,   7),I=1,7) / 1, 1,-1, 1,-1,-1, 0/
      DATA (NHEL(I,   8),I=1,7) / 1, 1,-1, 1,-1, 1, 0/
      DATA (NHEL(I,   9),I=1,7) / 1, 1, 1,-1, 1,-1, 0/
      DATA (NHEL(I,  10),I=1,7) / 1, 1, 1,-1, 1, 1, 0/
      DATA (NHEL(I,  11),I=1,7) / 1, 1, 1,-1,-1,-1, 0/
      DATA (NHEL(I,  12),I=1,7) / 1, 1, 1,-1,-1, 1, 0/
      DATA (NHEL(I,  13),I=1,7) / 1, 1, 1, 1, 1,-1, 0/
      DATA (NHEL(I,  14),I=1,7) / 1, 1, 1, 1, 1, 1, 0/
      DATA (NHEL(I,  15),I=1,7) / 1, 1, 1, 1,-1,-1, 0/
      DATA (NHEL(I,  16),I=1,7) / 1, 1, 1, 1,-1, 1, 0/
      DATA (NHEL(I,  17),I=1,7) / 1,-1,-1,-1, 1,-1, 0/
      DATA (NHEL(I,  18),I=1,7) / 1,-1,-1,-1, 1, 1, 0/
      DATA (NHEL(I,  19),I=1,7) / 1,-1,-1,-1,-1,-1, 0/
      DATA (NHEL(I,  20),I=1,7) / 1,-1,-1,-1,-1, 1, 0/
      DATA (NHEL(I,  21),I=1,7) / 1,-1,-1, 1, 1,-1, 0/
      DATA (NHEL(I,  22),I=1,7) / 1,-1,-1, 1, 1, 1, 0/
      DATA (NHEL(I,  23),I=1,7) / 1,-1,-1, 1,-1,-1, 0/
      DATA (NHEL(I,  24),I=1,7) / 1,-1,-1, 1,-1, 1, 0/
      DATA (NHEL(I,  25),I=1,7) / 1,-1, 1,-1, 1,-1, 0/
      DATA (NHEL(I,  26),I=1,7) / 1,-1, 1,-1, 1, 1, 0/
      DATA (NHEL(I,  27),I=1,7) / 1,-1, 1,-1,-1,-1, 0/
      DATA (NHEL(I,  28),I=1,7) / 1,-1, 1,-1,-1, 1, 0/
      DATA (NHEL(I,  29),I=1,7) / 1,-1, 1, 1, 1,-1, 0/
      DATA (NHEL(I,  30),I=1,7) / 1,-1, 1, 1, 1, 1, 0/
      DATA (NHEL(I,  31),I=1,7) / 1,-1, 1, 1,-1,-1, 0/
      DATA (NHEL(I,  32),I=1,7) / 1,-1, 1, 1,-1, 1, 0/
      DATA (NHEL(I,  33),I=1,7) /-1, 1,-1,-1, 1,-1, 0/
      DATA (NHEL(I,  34),I=1,7) /-1, 1,-1,-1, 1, 1, 0/
      DATA (NHEL(I,  35),I=1,7) /-1, 1,-1,-1,-1,-1, 0/
      DATA (NHEL(I,  36),I=1,7) /-1, 1,-1,-1,-1, 1, 0/
      DATA (NHEL(I,  37),I=1,7) /-1, 1,-1, 1, 1,-1, 0/
      DATA (NHEL(I,  38),I=1,7) /-1, 1,-1, 1, 1, 1, 0/
      DATA (NHEL(I,  39),I=1,7) /-1, 1,-1, 1,-1,-1, 0/
      DATA (NHEL(I,  40),I=1,7) /-1, 1,-1, 1,-1, 1, 0/
      DATA (NHEL(I,  41),I=1,7) /-1, 1, 1,-1, 1,-1, 0/
      DATA (NHEL(I,  42),I=1,7) /-1, 1, 1,-1, 1, 1, 0/
      DATA (NHEL(I,  43),I=1,7) /-1, 1, 1,-1,-1,-1, 0/
      DATA (NHEL(I,  44),I=1,7) /-1, 1, 1,-1,-1, 1, 0/
      DATA (NHEL(I,  45),I=1,7) /-1, 1, 1, 1, 1,-1, 0/
      DATA (NHEL(I,  46),I=1,7) /-1, 1, 1, 1, 1, 1, 0/
      DATA (NHEL(I,  47),I=1,7) /-1, 1, 1, 1,-1,-1, 0/
      DATA (NHEL(I,  48),I=1,7) /-1, 1, 1, 1,-1, 1, 0/
      DATA (NHEL(I,  49),I=1,7) /-1,-1,-1,-1, 1,-1, 0/
      DATA (NHEL(I,  50),I=1,7) /-1,-1,-1,-1, 1, 1, 0/
      DATA (NHEL(I,  51),I=1,7) /-1,-1,-1,-1,-1,-1, 0/
      DATA (NHEL(I,  52),I=1,7) /-1,-1,-1,-1,-1, 1, 0/
      DATA (NHEL(I,  53),I=1,7) /-1,-1,-1, 1, 1,-1, 0/
      DATA (NHEL(I,  54),I=1,7) /-1,-1,-1, 1, 1, 1, 0/
      DATA (NHEL(I,  55),I=1,7) /-1,-1,-1, 1,-1,-1, 0/
      DATA (NHEL(I,  56),I=1,7) /-1,-1,-1, 1,-1, 1, 0/
      DATA (NHEL(I,  57),I=1,7) /-1,-1, 1,-1, 1,-1, 0/
      DATA (NHEL(I,  58),I=1,7) /-1,-1, 1,-1, 1, 1, 0/
      DATA (NHEL(I,  59),I=1,7) /-1,-1, 1,-1,-1,-1, 0/
      DATA (NHEL(I,  60),I=1,7) /-1,-1, 1,-1,-1, 1, 0/
      DATA (NHEL(I,  61),I=1,7) /-1,-1, 1, 1, 1,-1, 0/
      DATA (NHEL(I,  62),I=1,7) /-1,-1, 1, 1, 1, 1, 0/
      DATA (NHEL(I,  63),I=1,7) /-1,-1, 1, 1,-1,-1, 0/
      DATA (NHEL(I,  64),I=1,7) /-1,-1, 1, 1,-1, 1, 0/
      DATA IDEN/ 4/
...
C     ----------
      ...
      CALL IXXXXX(P(0,2),MDL_MNUL,NHEL(2),+1*IC(2),W(1,2))
      CALL OXXXXX(P(0,3),MDL_ME,NHEL(3),+1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MNUL,NHEL(4),+1*IC(4),W(1,4))
      CALL IXXXXX(P(0,5),MDL_ME,NHEL(5),-1*IC(5),W(1,5))
      CALL OXXXXX(P(0,6),MDL_ME,NHEL(6),+1*IC(6),W(1,6))
      CALL FFV1_3(W(1,5),W(1,6),GC_17,MDL_MRHOD,MDL_WRHOD,W(1,7))
      CALL SXXXXX(P(0,7),+1*IC(7),W(1,6))
      CALL VVS1_1(W(1,7),W(1,6),GC_1,MDL_MAP,MDL_WAP,W(1,5))
      CALL FFV1_2(W(1,1),W(1,5),GC_16,MDL_ME,ZERO,W(1,6))
      CALL FF1P0_3(W(1,2),W(1,4),GC_14,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,3),W(1,7),GC_4,AMP(1))
      CALL FFV1_1(W(1,3),W(1,5),GC_16,MDL_ME,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,1),W(1,6),W(1,7),GC_4,AMP(2))
