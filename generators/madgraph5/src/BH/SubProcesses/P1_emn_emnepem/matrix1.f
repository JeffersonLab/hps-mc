...
C     
C     Process: e- n > e- n e+ e- QND<=1 / z h ap @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,1),W(1,3),GC_3,ZERO,ZERO,W(1,7))
      CALL FF1P0_3(W(1,2),W(1,4),GC_12,ZERO,ZERO,W(1,8))
      CALL FFV1_2(W(1,5),W(1,7),GC_3,MDL_ME,ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,6),W(1,8),GC_3,AMP(1))
      CALL FFV1_1(W(1,6),W(1,7),GC_3,MDL_ME,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,4),W(1,8),GC_3,AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,6),GC_3,ZERO,ZERO,W(1,4))
      CALL FFV1_1(W(1,3),W(1,4),GC_3,MDL_ME,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,5),W(1,7),W(1,8),GC_3,AMP(3))
      CALL FFV1_2(W(1,5),W(1,4),GC_3,MDL_ME,ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,3),W(1,8),GC_3,AMP(4))
      CALL FFV1P0_3(W(1,5),W(1,3),GC_3,ZERO,ZERO,W(1,7))
      CALL FFV1_2(W(1,1),W(1,8),GC_3,MDL_ME,ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,4),W(1,6),W(1,7),GC_3,AMP(5))
      CALL FFV1_2(W(1,1),W(1,7),GC_3,MDL_ME,ZERO,W(1,2))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,6),W(1,8),GC_3,AMP(6))
      CALL FFV1P0_3(W(1,5),W(1,6),GC_3,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,3),W(1,2),GC_3,AMP(7))
      CALL FFV1_2(W(1,1),W(1,2),GC_3,MDL_ME,ZERO,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,4),W(1,3),W(1,8),GC_3,AMP(8))
