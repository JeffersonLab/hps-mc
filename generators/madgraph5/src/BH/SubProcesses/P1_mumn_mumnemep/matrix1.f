...
C     
C     Process: mu- n > mu- n e- e+ QND<=1 $$ a / z h ap @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FF1P0_3(W(1,2),W(1,4),GC_12,ZERO,ZERO,W(1,3))
      CALL FFV1_1(W(1,5),W(1,7),GC_3,MDL_ME,ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,4),W(1,3),GC_3,AMP(1))
      CALL FFV1_2(W(1,6),W(1,7),GC_3,MDL_ME,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,5),W(1,3),GC_3,AMP(2))
