...
class RunCardLO(RunCard):
    ...
    def default_setup(self):
        ...
        self.add_param("thetalmaxsp", 100.0)
        self.add_param("thetaxlminsp", 0.0)
        self.add_param("thetaxlmaxsp", 100.0)
        self.add_param("thetaylminsp", 0.0)
        self.add_param("thetaylmaxsp", 100.0)
        self.add_param("elmins", 0.0)
        self.add_param("elmaxs", 100.0)
        self.add_param("thetalmins", 0.0)
        self.add_param("thetalmaxs", 100.0)
        self.add_param("thetaxlmins", 0.0)
        self.add_param("thetaxlmaxs", 100.0)
        self.add_param("thetaylmins", 0.0)
        self.add_param("thetaylmaxs", 100.0)
        #pt cut
