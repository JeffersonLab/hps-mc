...
C     
     ...
     $ +(P1(2)*-1D0*(+CI*(V3(3)+V3(6)))+P1(3)*(V3(4)+CI*(V3(5))))))+M1
     $ *(F2(5)*(V3(3)+V3(6))+F2(6)*(V3(4)+CI*(V3(5))))))
      F1(4)= DENOM*-CI*(F2(3)*(P1(0)*(+CI*(V3(5))-V3(4))+(P1(1)*(V3(3)
     $ -V3(6))+(P1(2)*(-CI*(V3(3))+CI*(V3(6)))+P1(3)*(V3(4)-CI*(V3(5)))
     $ )))+(F2(4)*(P1(0)*(V3(3)+V3(6))+(P1(1)*-1D0*(V3(4)+CI*(V3(5)))
     $ +(P1(2)*(+CI*(V3(4))-V3(5))-P1(3)*(V3(3)+V3(6)))))+M1*(F2(5)*(
     $ +CI*(V3(5))-V3(4))+F2(6)*(V3(6)-V3(3)))))
     ...
     $ +V3(6))+(P1(2)*-1D0*(+CI*(V3(3)+V3(6)))+P1(3)*(+CI*(V3(5))-V3(4)
     $ ))))+(F2(6)*(P1(0)*(V3(6)-V3(3))+(P1(1)*(V3(4)+CI*(V3(5)))
