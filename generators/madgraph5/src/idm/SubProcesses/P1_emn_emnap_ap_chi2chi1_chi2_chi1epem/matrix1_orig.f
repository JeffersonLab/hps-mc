...
C     ----------
     ...
     $    ABS(MDL_MAP*SMALL_WIDTH_TREATMENT)), MDL_WAP)
      ...
      CALL IXXXXX(P(0,5),MDL_MCHI1,NHEL(5),-1*IC(5),W(1,5))
      CALL IXXXXX(P(0,6),MDL_ME,NHEL(6),-1*IC(6),W(1,6))
      CALL OXXXXX(P(0,7),MDL_ME,NHEL(7),+1*IC(7),W(1,7))
      CALL FFV2_4_3(W(1,6),W(1,7),GC_36,GC_45,MDL_MZ, FK_MDL_WZ,W(1,8))
      CALL FFV1C1_2(W(1,5),W(1,8),GC_17,MDL_MCHI2, FK_MDL_WCHI2,W(1,9))
      CALL OXXXXX(P(0,8),MDL_MCHI1,NHEL(8),+1*IC(8),W(1,8))
      CALL FFV1_3(W(1,9),W(1,8),GC_14,MDL_MAP, FK_MDL_WAP,W(1,10))
      CALL FFV2_4_2(W(1,1),W(1,10),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,9))
      CALL FF1P0_3(W(1,2),W(1,4),GC_87,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,9),W(1,3),W(1,11),GC_4,AMP(1))
      CALL FFV2_4_3(W(1,6),W(1,7),GC_39,GC_48,MDL_MAP, FK_MDL_WAP,W(1
     $ ,9))
      CALL FFV1C1_2(W(1,5),W(1,9),GC_14,MDL_MCHI2, FK_MDL_WCHI2,W(1,7))
      CALL FFV1_3(W(1,7),W(1,8),GC_14,MDL_MAP, FK_MDL_WAP,W(1,9))
      CALL FFV2_4_2(W(1,1),W(1,9),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,7),W(1,3),W(1,11),GC_4,AMP(2))
      CALL FFV2_4_1(W(1,3),W(1,10),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,1),W(1,7),W(1,11),GC_4,AMP(3))
      CALL FFV2_4_1(W(1,3),W(1,9),GC_39,GC_48,MDL_ME, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,7),W(1,11),GC_4,AMP(4))
