...
class RunCardLO(RunCard):
    ...
    def default_setup(self):
        ...
        # newly add run_card variables for HPS fixed-target
        # positron
        self.add_param("eminpos", 0.0)
        self.add_param("emaxpos", 100.0)
        self.add_param("thetaminpos", 0.0)
        self.add_param("thetamaxpos", 100.0)
        self.add_param("thetaxminpos", 0.0)
        self.add_param("thetaxmaxpos", 100.0)
        self.add_param("thetayminpos", 0.0)
        self.add_param("thetaymaxpos", 100.0)
        # electron
        self.add_param("eminele", 0.0)
        self.add_param("emaxele", 100.0)
        self.add_param("thetaminele", 0.0)
        self.add_param("thetamaxele", 100.0)
        self.add_param("thetaxminele", 0.0)
        self.add_param("thetaxmaxele", 100.0)
        self.add_param("thetayminele", 0.0)
        self.add_param("thetaymaxele", 100.0)
        # recoil electron
        self.add_param("eminrecoil", 0.0)
        self.add_param("emaxrecoil", 100.0)
        self.add_param("thetaminrecoil", 0.0)
        self.add_param("thetamaxrecoil", 100.0)
        self.add_param("thetaxminrecoil", 0.0)
        self.add_param("thetaxmaxrecoil", 100.0)
        self.add_param("thetayminrecoil", 0.0)
        self.add_param("thetaymaxrecoil", 100.0)
        # any lepton
        self.add_param("eminanyl", 0.0)
        self.add_param("emaxanyl", 100.0)
        self.add_param("thetaminanyl", 0.0)
        self.add_param("thetamaxanyl", 100.0)
        self.add_param("thetaxminanyl", 0.0)
        self.add_param("thetaxmaxanyl", 100.0)
        self.add_param("thetayminanyl", 0.0)
        self.add_param("thetaymaxanyl", 100.0)
        # electron-positron pair cuts
        self.add_param("eltot", 0.0)
        self.add_param("mmeemin", 0.0)
        self.add_param("mmeemax", 100.0)
        self.add_param("thetaratiomin", 0.0)
        self.add_param("thetaratiomax", 100.0)
        #pt cut
