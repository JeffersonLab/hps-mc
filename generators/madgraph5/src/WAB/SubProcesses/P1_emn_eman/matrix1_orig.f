...
C     
C     Process: e- n > e- a n QND<=1 / ap @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL OXXXXX(P(0,5),MDL_MNUL,NHEL(5),+1*IC(5),W(1,5))
      CALL FFV1_2(W(1,1),W(1,4),GC_3,MDL_ME, FK_ZERO,W(1,6))
      CALL FF1P0_3(W(1,2),W(1,5),GC_12,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,3),W(1,7),GC_3,AMP(1))
      CALL FFV1_1(W(1,3),W(1,4),GC_3,MDL_ME, FK_ZERO,W(1,6))
