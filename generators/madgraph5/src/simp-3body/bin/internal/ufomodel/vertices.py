...
V_74 = Vertex(name = 'V_74',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_138,(0,1):C.GC_136})

V_75 = Vertex(name = 'V_75',
              particles = [ P.c__tilde__, P.c, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_111,(0,1):C.GC_109})

V_76 = Vertex(name = 'V_76',
              particles = [ P.t__tilde__, P.t, P.G0 ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_130,(0,1):C.GC_128})
...
V_80 = Vertex(name = 'V_80',
              particles = [ P.Ap, P.rhoD, P.piD ],
              color = [ '1' ],
              lorentz = [ L.VVS1 ],
              couplings = {(0,0):C.GC_1})

V_81 = Vertex(name = 'V_81',
              particles = [ P.e__plus__, P.e__minus__, P.rhoD ],
              color = [ '1' ],
              lorentz = [ L.FFV1 ],
