...
dOverFpiD = Parameter(name = 'dOverFpiD',
                      nature = 'external',
                      type = 'real',
                      value = 0.01,
                      texname = '\\text{dOverFpiD}',
                      lhablock = 'FRBlock',
                      lhacode = [ 12 ])

gree = Parameter(name = 'gree',
                 nature = 'external',
                 type = 'real',
                 value = 0.001,
                 texname = '\\text{gree}',
