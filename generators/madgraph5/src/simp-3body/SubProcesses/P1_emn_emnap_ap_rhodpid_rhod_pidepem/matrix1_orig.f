...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,  57),I=1,8) /-1,-1, 1,-1, 0, 1,-1, 0/
      DATA (NHEL(I,  58),I=1,8) /-1,-1, 1,-1, 0, 1, 1, 0/
      DATA (NHEL(I,  59),I=1,8) /-1,-1, 1,-1, 0,-1,-1, 0/
      DATA (NHEL(I,  60),I=1,8) /-1,-1, 1,-1, 0,-1, 1, 0/
      DATA (NHEL(I,  61),I=1,8) /-1,-1, 1, 1, 0, 1,-1, 0/
      DATA (NHEL(I,  62),I=1,8) /-1,-1, 1, 1, 0, 1, 1, 0/
      DATA (NHEL(I,  63),I=1,8) /-1,-1, 1, 1, 0,-1,-1, 0/
      DATA (NHEL(I,  64),I=1,8) /-1,-1, 1, 1, 0,-1, 1, 0/
      DATA IDEN/ 4/
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL IXXXXX(P(0,1),MDL_ME,NHEL(1),+1*IC(1),W(1,1))
      CALL IXXXXX(P(0,2),MDL_MNUC,NHEL(2),+1*IC(2),W(1,2))
      CALL OXXXXX(P(0,3),MDL_ME,NHEL(3),+1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_MNUC,NHEL(4),+1*IC(4),W(1,4))
      CALL SXXXXX(P(0,5),+1*IC(5),W(1,5))
      CALL IXXXXX(P(0,6),MDL_ME,NHEL(6),-1*IC(6),W(1,6))
      CALL OXXXXX(P(0,7),MDL_ME,NHEL(7),+1*IC(7),W(1,7))
      CALL FFV1_3(W(1,6),W(1,7),GC_16,MDL_MAP, FK_MDL_WAP,W(1,8))
      CALL VVS1_2(W(1,8),W(1,5),GC_1,MDL_MRHOD, FK_MDL_WRHOD,W(1,7))
      CALL SXXXXX(P(0,8),+1*IC(8),W(1,8))
      CALL VVS1_1(W(1,7),W(1,8),GC_1,MDL_MAP, FK_MDL_WAP,W(1,5))
      CALL FFV1_2(W(1,1),W(1,5),GC_16,MDL_ME, FK_ZERO,W(1,8))
      CALL FF1P0_3(W(1,2),W(1,4),GC_14,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,3),W(1,7),GC_4,AMP(1))
      CALL FFV1_1(W(1,3),W(1,5),GC_16,MDL_ME, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,1),W(1,8),W(1,7),GC_4,AMP(2))
