...
class TestRunParams(unittest.TestCase):
    ...
    def test_run_params1pt1(self):
        ...
        self.assertEqual(rp.get("target_thickness"), 0.0004062)
    ...
    def test_run_params1pt92(self):
        ...
        self.assertEqual(rp.get("target_thickness"), 0.0008)
    ...
    def test_run_params3pt7(self):
        ...
        self.assertEqual(rp.get("aprime_mass")[0], 15)
        self.assertEqual(rp.get("target_thickness"), 0.002)
    ...
    def test_run_params3pt74(self):
        ...
        self.assertEqual(rp.get("target_thickness"), 0.000875)
