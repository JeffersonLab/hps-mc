...
from hpsmc.tools import (ExtractEventsWithHitAtHodoEcal,
                         EvioToLcio, JobManager,
                         FilterBunches, LCIOCount, HPSTR)

job.description = 'slic signal to recon'
...
filter_events = ExtractEventsWithHitAtHodoEcal(
    inputs=signal_file_name,
...
space_overlay = FilterBunches(inputs=filter_events.output_files(),
                              filter_no_cuts=True,
...
# Add the components
job.add([filter_events, count_filter, space_overlay,
