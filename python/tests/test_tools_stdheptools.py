...
class TestMergePoisson(unittest.TestCase):
    ...
    def test_setup_1pt1_xsec1(self):
        ...
        merge_poisson.set_parameters({'run_params': '1pt1', 'target_thickness': 0.0004062, 'num_electrons': 625})
        merge_poisson.setup()
    ...
    def test_setup_3pt74_xsec1(self):
        merge_poisson = MergePoisson(inputs=['input1.stdhep', 'input2.stdhep'], outputs=['output.stdhep'], xsec=1)
        merge_poisson.set_parameters({'run_params': '3pt74', 'target_thickness': 0.000875, 'num_electrons': 625})
        merge_poisson.setup()
    ...
    def test_cmd_args(self):
        merge_poisson = MergePoisson(inputs=['input1.stdhep', 'input2.stdhep'], outputs=['output.stdhep'], xsec=1)
        merge_poisson.set_parameters({'run_params': '1pt1', 'target_thickness': 0.0004062, 'num_electrons': 625, 'mu': 1, 'seed': 2, 'nevents': 100})
        merge_poisson.setup()
