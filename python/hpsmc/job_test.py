...
slic = SLIC(geometry="HPS-EngRun2015-Nominal-v3", inputs=["moller.stdhep"], outputs=["slic_events.slcio"], nevents=10)

# run simple hps-java job
hps_java = HPSJava(inputs=["slic_events.slcio"], steering_resource="/org/hps/steering/EventMarker.lcsim")
