...
C     
C     Process: mu- n > a > mu- n e- e+ QND<=1 / z h ap @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,6),W(1,5),GC_3,ZERO,ZERO,W(1,4))
      CALL FFV1_2(W(1,1),W(1,7),GC_3,MDL_MM,ZERO,W(1,6))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,3),W(1,4),GC_3,AMP(1))
      CALL FFV1_2(W(1,1),W(1,4),GC_3,MDL_MM,ZERO,W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,3),W(1,7),GC_3,AMP(2))
