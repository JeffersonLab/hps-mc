...
# Functions to compute hidden sector decay fractions (using decayLength5sel model equations)
...
def main():
    ...
    # Import the signal base module (e.g., decayLength5sel.py) dynamically
    try:
    ...
    alpha_D = 0.01  # fixed in decayLength5sel
    m_pi_D = mass_mev / 3.0
    ...
    features_to_plot = ["vertex.pos_.fZ", "ele.track_.z0_", "pos.track_.z0_", "psum", "vtx_proj_sig"]
