...
def main():
    ...
    param_list = [[90,1e-2],[90,8e-3],[90,5e-3],[90,2e-3]]
    ...
    for mass_mev,epsilon in param_list:
        ...
        for feat in features_to_plot:
            ...
            if((count==1)):
                ...
                print("I am printing background shape")
                print(b_w)
    ...
    for I in range(len(features_to_plot)):
        ...
        for J in range(len(param_list)):
            plt.hist(plotarray_data[1+J][I],bins=plotarray_bins[1+J][I],range=plotarray_ranges[1+J][I], weights=plotarray_weights[1+J][I],histtype="step",linewidth=1.8,label="Mass: "+str(param_list[J][0])+", eps: "+str(param_list[J][1]))
