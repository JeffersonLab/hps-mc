...
num_entries=176             # Change this to the desired number of lhe files to read
...
for i in $(seq 0 "$num_entries"); do
    ...
    new_entry=$(echo "$template" | sed "
        ...
        s|\"/home/groups/laurenat/majd/lhe_files/phiKK_4550_MeV_7883/phiKK_4550_MeV_7883_[0-9]*.lhe\"|\"/home/groups/laurenat/majd/lhe_files/phiKK_4550_MeV_7883/phiKK_4550_MeV_7883_$i.lhe\"|
    ")
